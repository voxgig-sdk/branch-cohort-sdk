...
from branchcohort_sdk.core.control import BranchCohortControl
...
from branchcohort_sdk.core.helpers import get_ctx_prop, to_map
...
class BranchCohortContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, BranchCohortSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BranchCohortResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BranchCohortResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BranchCohortError(code, msg, self)
