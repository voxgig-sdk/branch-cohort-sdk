...
from branchcohort_sdk.utility import register

# Load features
from branchcohort_sdk.feature.base_feature import BranchCohortBaseFeature
from branchcohort_sdk.features import _has_feature, _make_feature
...
class BranchCohortSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BranchCohortUtility()
        self._utility = utility

        from branchcohort_sdk.config import shared_config
    ...
    def get_utility(self):
        return BranchCohortUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BranchCohortSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Analytics(self, data=None) -> "AnalyticsEntity":
        ...
        from branchcohort_sdk.entity.analytics_entity import AnalyticsEntity
        return AnalyticsEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BranchCohortSDK":
        if sdkopts is None:
            sdkopts = {}
