# BranchCohort SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BranchCohortSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BranchCohortSDK(...) and BranchCohortSDK.test(...) become
#      BranchCohortSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "branchcohort_sdk"
_SDK_CLASS = "BranchCohortSDK"
