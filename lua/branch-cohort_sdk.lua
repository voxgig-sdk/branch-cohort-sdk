...
local BranchCohortSDK = {}
BranchCohortSDK.__index = BranchCohortSDK
...
BranchCohortSDK._make_feature = _make_feature


function BranchCohortSDK.new(options)
  local self = setmetatable({}, BranchCohortSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function BranchCohortSDK:options_map()
...
function BranchCohortSDK:get_utility()
  return Utility.copy(self._utility)
end


function BranchCohortSDK:get_root_ctx()
  return self._rootctx
end


function BranchCohortSDK:prepare(fetchargs)
...
function BranchCohortSDK:direct(fetchargs)
...
-- by passing it.
function BranchCohortSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function BranchCohortSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "BranchCohortSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function BranchCohortSDK:Analytics(data)
...
function BranchCohortSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = BranchCohortSDK.new(sdkopts)
  sdk.mode = "test"
