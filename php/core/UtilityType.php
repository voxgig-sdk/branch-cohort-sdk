...
// BranchCohort SDK utility type

class BranchCohortUtility
{
    ...
    public static function copy(BranchCohortUtility $src): BranchCohortUtility
    {
        $u = new BranchCohortUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
