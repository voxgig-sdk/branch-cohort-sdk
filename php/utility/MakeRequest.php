...
// BranchCohort SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BranchCohortMakeRequest
{
    public static function call(BranchCohortContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BranchCohortResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BranchCohortResponse($fetched);
        } else {
