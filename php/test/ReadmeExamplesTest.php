...
// BranchCohort SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BranchCohortSDK::test)
...
{
    private const SDK_CLASS = 'BranchCohortSDK';
    ...
    private const SDK_BASE = 'branchcohort_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../branchcohort_sdk.php';
