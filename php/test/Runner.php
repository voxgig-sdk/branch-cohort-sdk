...
class BranchCohortTestRunner
{
    ...
    {
        $live = self::getenv('BRANCH_COHORT_TEST_LIVE');
        $override = self::getenv('BRANCH_COHORT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BRANCH_COHORT_TEST_EXPLAIN');
...
class_alias('BranchCohortTestRunner', 'Runner');
class_alias('BranchCohortHelpers', 'Helpers');
