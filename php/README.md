# BranchCohort PHP SDK



The PHP SDK for the BranchCohort API — an entity-oriented client using PHP conventions.
...
```php
<?php
require_once 'branchcohort_sdk.php';
...
| `filter` | `array` | "Keys are same as dimensions. |
...
| `measures` | `array` | The cohort measures to return. |
...
```
php/
├── branchcohort_sdk.php          -- Main SDK class
...
The main class (`branchcohort_sdk.php`) exports the SDK class
