...
from projectname_sdk import BranchCohortSDK
from projectname_sdk.core.spec import BranchCohortSpec
from projectname_sdk.core.result import BranchCohortResult
from projectname_sdk.core.operation import BranchCohortOperation
from projectname_sdk.core.error import BranchCohortError
from projectname_sdk.feature.base_feature import BranchCohortBaseFeature
...
_runner = makeRunner(TEST_JSON_FILE, BranchCohortSDK.test(None, None))
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return BranchCohortError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = BranchCohortSDK.test(None, None)
        utility = client._utility
    ...
    def test_feature_init_basic(self):
        init_client = BranchCohortSDK.test(None, None)
        ...
        class TestInitFeature(BranchCohortBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BranchCohortBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = BranchCohortSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BranchCohortSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BranchCohortSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BranchCohortSDK.test(None, setup.get('a') or {})
