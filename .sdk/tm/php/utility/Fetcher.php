...
// BranchCohort SDK utility: fetcher

class BranchCohortFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BranchCohortSDK/1.0)';
    ...
    public static function call(BranchCohortContext $ctx, string $fullurl, array $fetchdef): array
    {
