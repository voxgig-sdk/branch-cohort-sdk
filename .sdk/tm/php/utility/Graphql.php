...
// BranchCohort SDK utility: graphql
//
...
class BranchCohortGraphql
{
    ...
    // equivalent.
    public static function body(BranchCohortContext $ctx): mixed
    {
    ...
    public static function errors(BranchCohortContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
