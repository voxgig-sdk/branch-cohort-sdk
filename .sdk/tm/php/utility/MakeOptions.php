...
// BranchCohort SDK utility: make_options

class BranchCohortMakeOptions
{
    ...
    public static function call(BranchCohortContext $ctx): array
    {
        ...
        //
        // `BranchCohortSchema::optspec()` is built from the model:
        ...
        $optspec = BranchCohortSchema::optspec();
