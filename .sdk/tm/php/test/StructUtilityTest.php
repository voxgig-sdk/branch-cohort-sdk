...
// BranchCohort SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BranchCohortOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BranchCohortOmni::structfix($now, Struct::undef()))
                        !== json_encode(BranchCohortOmni::structfix($val, Struct::undef()))) {
