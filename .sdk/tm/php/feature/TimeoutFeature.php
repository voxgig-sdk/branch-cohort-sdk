...
// BranchCohort SDK timeout feature
...
class BranchCohortTimeoutFeature extends BranchCohortBaseFeature
{
    ...
    private function _with_timeout(BranchCohortContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BranchCohortContext $_ctx, float $ms): void
    {
        $client = $this->client;
