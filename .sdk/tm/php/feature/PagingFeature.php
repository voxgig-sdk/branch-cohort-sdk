...
class BranchCohortPagingFeature extends BranchCohortBaseFeature
{
    ...
    private function _graphql_pre_request(BranchCohortContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BranchCohortContext $ctx): bool
    {
