...
// BranchCohort SDK ratelimit feature
...
class BranchCohortRatelimitFeature extends BranchCohortBaseFeature
{
    ...
    private function _acquire(BranchCohortContext $ctx): void
    {
    ...
    private function _track(BranchCohortContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
