...
|---|---|---|
| `js/` | @voxgig-sdk/branch-cohort-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/branch-cohort | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/branch-cohort-js \
      --repository voxgig-sdk/branch-cohort-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/branch-cohort-js` shows it, and
`npm trust revoke @voxgig-sdk/branch-cohort-js --id=<id>` removes it.
