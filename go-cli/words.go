...
func registerSDKWords(r *eng.Registry, client *sdk.BranchCohortSDK) {
...
func runOp(client *sdk.BranchCohortSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
