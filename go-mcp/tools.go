...
type Args struct {
	Entity string         `json:"entity" jsonschema:"analytics"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BranchCohortSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-cohort_list",
		Description: "List records from BranchCohort. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "branch-cohort_load",
		Description: "Load a single record from BranchCohort. " +
...
func runOp(client *sdk.BranchCohortSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BranchCohortSDK, name string) (sdk.BranchCohortEntity, error) {
