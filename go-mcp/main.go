// Command BranchCohort-mcp is an MCP server exposing the BranchCohort
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BranchCohort_list  — list records of an entity
//	BranchCohort_load  — load a single record of an entity
//
