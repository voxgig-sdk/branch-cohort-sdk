...
import (
	...
	vs "github.com/voxgig-sdk/branch-cohort-sdk/go/utility/struct"
)

type BranchCohortSDK struct {
	Mode     string
...
func (sdk *BranchCohortSDK) OptionsMap() map[string]any {
...
func (sdk *BranchCohortSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BranchCohortSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BranchCohortSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BranchCohortSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BranchCohortSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BranchCohortSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BranchCohortSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BranchCohortSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BranchCohortSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BranchCohortSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *BranchCohortSDK) Analytics(data map[string]any) BranchCohortEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *BranchCohortSDK {
	...
	sdk := NewBranchCohortSDK(sdkopts)
	sdk.Mode = "test"
