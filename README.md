...
Cohort API client, generated from the OpenAPI spec.

The Cohort API allows you to programmatically query and export Cohort analytics

Learn more about Cohort API at [api2.branch.io](https://api2.branch.io).

This is an unofficial SDK for the Cohort public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.

Learn more about Voxgig SDKs at [voxgig.com/sdk](https://voxgig.com/sdk/).

Full documentation for this SDK: [https://voxgig-sdk.github.io/branch-cohort-sdk/](https://voxgig-sdk.github.io/branch-cohort-sdk/)
...
This SDK exposes the API as a small set of **semantic entities** — Analytics — that you
...
const client = BranchCohortSDK.test({
  entity: {
    analytics: {
      test01: { id: 'test01', app_id: 'example_app_id', format: 'example_format', limit: 1 },
    },
  },
})
const analytics = await client.Analytics().load({ id: 'test01', app_id: 'example_app_id', format: 'example_format' })
// analytics is the Analytics entity, populated with mock data
...
const client = BranchCohortSDK.test()
const analytics = await client.Analytics().load({ id: 'test01', app_id: 'example_app_id', format: 'example_format' })
// analytics is the entity, populated with mock data
// — call analytics.data() for the record itself
console.log(analytics)
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/branch-cohort` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-cohort-sdk/tags) |
| Python | `voxgig-sdk-branch-cohort` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-cohort-sdk/tags) |
| PHP | `voxgig-sdk/branch-cohort` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-cohort-sdk/tags) |
| Golang | `github.com/voxgig-sdk/branch-cohort-sdk/go` | `go get github.com/voxgig-sdk/branch-cohort-sdk/go@latest` |
| Lua | `voxgig-sdk-branch-cohort` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-cohort-sdk/tags) |
| JavaScript | `@voxgig-sdk/branch-cohort-js` | publish pending — [install from git tag](https://github.com/voxgig-sdk/branch-cohort-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/branch-cohort-sdk/go-cli` | `go install github.com/voxgig-sdk/branch-cohort-sdk/go-cli/cmd/branch-cohort@latest` |
| Go MCP server | `github.com/voxgig-sdk/branch-cohort-sdk/go-mcp` | `go get github.com/voxgig-sdk/branch-cohort-sdk/go-mcp@latest` |
...
```bash
cd go-mcp && go build -o branch-cohort-mcp .
```
...
```json
{
  "mcpServers": {
    "branch-cohort": {
      "command": "/abs/path/to/branch-cohort-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Analytics** | The Analytics entity (create, load). | `/analytics/{job_id}` |
...
```go
import sdk "github.com/voxgig-sdk/branch-cohort-sdk/go"
...
Generated from the Cohort API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
